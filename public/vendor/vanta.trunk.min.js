/*!
 * vanta.trunk v0.5.24 — https://github.com/tengbao/vanta
 * Copyright (c) 2021 Teng Bao. Licensed under the MIT license.
 *
 * Vendored for the same reason as three.min.js above (offline-capable app, no
 * third-party script loads). Requires the pinned three r134 build loaded
 * first — see public/bg.js.
 * Regenerate with:
 *   npm install --save-dev vanta@0.5.24 && cp node_modules/vanta/dist/vanta.trunk.min.js public/vendor/
 */
